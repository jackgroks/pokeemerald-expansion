...
#define BATTLE_TYPE_TWO_OPPONENTS_FULL (1 << 14)  // Set alongside BATTLE_TYPE_TWO_OPPONENTS to allow 6+6 opponent parties
...
#define BATTLE_TYPE_TWO_PLAYERS_FULL   (1 << 30) // Set alongside BATTLE_TYPE_INGAME_PARTNER to allow a 6-mon partner party stored in gPartnerPlayerParty
...
#define BATTLE_TYPE_PLAYER_HAS_PARTNER      (BATTLE_TYPE_MULTI | BATTLE_TYPE_INGAME_PARTNER | BATTLE_TYPE_TOWER_LINK_MULTI | BATTLE_TYPE_TWO_PLAYERS_FULL)
