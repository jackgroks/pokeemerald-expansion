...
enum __attribute__((packed)) Item
{
    ...
    // Charms
    ITEM_OVAL_CHARM = 691,
    ITEM_SHINY_CHARM = 692,
    ITEM_CATCHING_CHARM = 693,
    ITEM_EXP_CHARM = 694,

    // Form-changing Key Items
    ITEM_ROTOM_CATALOG = 695,
    ITEM_GRACIDEA = 696,
    ITEM_REVEAL_GLASS = 697,
    ITEM_DNA_SPLICERS = 698,
    ITEM_ZYGARDE_CUBE = 699,
    ITEM_PRISON_BOTTLE = 700,
    ITEM_N_SOLARIZER = 701,
    ITEM_N_LUNARIZER = 702,
    ITEM_REINS_OF_UNITY = 703,

    // Battle Mechanic Key Items
    ITEM_MEGA_RING = 704,
    ITEM_Z_POWER_RING = 705,
    ITEM_DYNAMAX_BAND = 706,
    ...
    ITEM_GOOD_ROD = 711,
    ITEM_SUPER_ROD = 712,
    ITEM_DOWSING_MACHINE = 713,
    ITEM_ITEMFINDER = ITEM_DOWSING_MACHINE, // Pre-Gen IV name
    ITEM_DOWSING_MCHN = ITEM_DOWSING_MACHINE, // Gen IV-V name
    ITEM_TOWN_MAP = 714,
    ITEM_VS_SEEKER = 715,
    ITEM_TM_CASE = 716,
    ITEM_BERRY_POUCH = 717,
    ITEM_POKEMON_BOX_LINK = 718,
    ITEM_POKEMON_BOX = ITEM_POKEMON_BOX_LINK, // Pre-Gen VIII name
    ITEM_COIN_CASE = 719,
    ITEM_POWDER_JAR = 720,
    ITEM_WAILMER_PAIL = 721,
    ITEM_POKE_RADAR = 722,
    ITEM_POKEBLOCK_CASE = 723,
    ITEM_SOOT_SACK = 724,
    ITEM_POKE_FLUTE = 725,
    ITEM_FAME_CHECKER = 726,
    ITEM_TEACHY_TV = 727,

    // Story Key Items
    ITEM_SS_TICKET = 728,
    ITEM_EON_TICKET = 729,
    ITEM_MYSTIC_TICKET = 730,
    ITEM_AURORA_TICKET = 731,
    ITEM_OLD_SEA_MAP = 732,
    ITEM_LETTER = 733,
    ITEM_DEVON_PARTS = 734,
    ITEM_DEVON_GOODS = ITEM_DEVON_PARTS, // Pre-Gen VI name
    ITEM_GO_GOGGLES = 735,
    ITEM_DEVON_SCOPE = 736,
    ITEM_BASEMENT_KEY = 737,
    ITEM_SCANNER = 738,
    ITEM_STORAGE_KEY = 739,
    ITEM_KEY_TO_ROOM_1 = 740,
    ITEM_RM_1_KEY = ITEM_KEY_TO_ROOM_1, // Pre-Gen VI name
    ITEM_KEY_TO_ROOM_2 = 741,
    ITEM_RM_2_KEY = ITEM_KEY_TO_ROOM_2, // Pre-Gen VI name
    ITEM_KEY_TO_ROOM_4 = 742,
    ITEM_RM_4_KEY = ITEM_KEY_TO_ROOM_4, // Pre-Gen VI name
    ITEM_KEY_TO_ROOM_6 = 743,
    ITEM_RM_6_KEY = ITEM_KEY_TO_ROOM_6, // Pre-Gen VI name
    ITEM_METEORITE = 744,
    ITEM_MAGMA_EMBLEM = 745,
    ITEM_CONTEST_PASS = 746,
    ITEM_PARCEL = 747,
    ITEM_OAKS_PARCEL = ITEM_PARCEL, // Pre-Gen IV name
    ITEM_SECRET_KEY = 748,
    ITEM_BIKE_VOUCHER = 749,
    ITEM_GOLD_TEETH = 750,
    ITEM_CARD_KEY = 751,
    ITEM_LIFT_KEY = 752,
    ITEM_SILPH_SCOPE = 753,
    ITEM_TRI_PASS = 754,
    ITEM_RAINBOW_PASS = 755,
    ITEM_TEA = 756,
    ITEM_RUBY = 757,
    ITEM_SAPPHIRE = 758,

    // GEN IX ITEMS
    ITEM_ABILITY_SHIELD = 759,
    ITEM_CLEAR_AMULET = 760,
    ITEM_PUNCHING_GLOVE = 761,
    ITEM_COVERT_CLOAK = 762,
    ITEM_LOADED_DICE = 763,
    ITEM_AUSPICIOUS_ARMOR = 764,
    ITEM_BOOSTER_ENERGY = 765,
    ITEM_BIG_BAMBOO_SHOOT = 766,
    ITEM_GIMMIGHOUL_COIN = 767,
    ITEM_LEADERS_CREST = 768,
    ITEM_MALICIOUS_ARMOR = 769,
    ITEM_MIRROR_HERB = 770,
    ITEM_SCROLL_OF_DARKNESS = 771,
    ITEM_SCROLL_OF_WATERS = 772,
    ITEM_TERA_ORB = 773,
    ITEM_TINY_BAMBOO_SHOOT = 774,

    ITEM_BUG_TERA_SHARD = 775,
    ITEM_DARK_TERA_SHARD = 776,
    ITEM_DRAGON_TERA_SHARD = 777,
    ITEM_ELECTRIC_TERA_SHARD = 778,
    ITEM_FAIRY_TERA_SHARD = 779,
    ITEM_FIGHTING_TERA_SHARD = 780,
    ITEM_FIRE_TERA_SHARD = 781,
    ITEM_FLYING_TERA_SHARD = 782,
    ITEM_GHOST_TERA_SHARD = 783,
    ITEM_GRASS_TERA_SHARD = 784,
    ITEM_GROUND_TERA_SHARD = 785,
    ITEM_ICE_TERA_SHARD = 786,
    ITEM_NORMAL_TERA_SHARD = 787,
    ITEM_POISON_TERA_SHARD = 788,
    ITEM_PSYCHIC_TERA_SHARD = 789,
    ITEM_ROCK_TERA_SHARD = 790,
    ITEM_STEEL_TERA_SHARD = 791,
    ITEM_WATER_TERA_SHARD = 792,

    ITEM_ADAMANT_CRYSTAL = 793,
    ITEM_GRISEOUS_CORE = 794,
    ITEM_LUSTROUS_GLOBE = 795,

    ITEM_BLACK_AUGURITE = 796,
    ITEM_LINKING_CORD = 797,
    ITEM_PEAT_BLOCK = 798,
    ITEM_BERSERK_GENE = 799,

    ITEM_FAIRY_FEATHER = 800,
    ITEM_SYRUPY_APPLE = 801,
    ITEM_UNREMARKABLE_TEACUP = 802,
    ITEM_MASTERPIECE_TEACUP = 803,
    ITEM_CORNERSTONE_MASK = 804,
    ITEM_WELLSPRING_MASK = 805,
    ITEM_HEARTHFLAME_MASK = 806,
    ITEM_HEALTH_MOCHI = 807,
    ITEM_MUSCLE_MOCHI = 808,
    ITEM_RESIST_MOCHI = 809,
    ITEM_GENIUS_MOCHI = 810,
    ITEM_CLEVER_MOCHI = 811,
    ITEM_SWIFT_MOCHI = 812,
    ITEM_FRESH_START_MOCHI = 813,
    ITEM_GLIMMERING_CHARM = 814,
    ITEM_METAL_ALLOY = 815,
    ITEM_STELLAR_TERA_SHARD = 816,

    ITEM_JUBILIFE_MUFFIN = 817,
    ITEM_REMEDY = 818,
    ITEM_FINE_REMEDY = 819,
    ITEM_SUPERB_REMEDY = 820,
    ITEM_AUX_EVASION = 821,
    ITEM_AUX_GUARD = 822,
    ITEM_AUX_POWER = 823,
    ITEM_AUX_POWERGUARD = 824,
    ITEM_CHOICE_DUMPLING = 825,
    ITEM_SWAP_SNACK = 826,
    ITEM_TWICE_SPICED_RADISH = 827,
    ITEM_POKESHI_DOLL = 828,

    ITEM_STRANGE_BALL = 829,
